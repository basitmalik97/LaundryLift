      ...
      <div className="bg-container">
        <div className="gradient-section">
          ...
          <div className="herobox1">
            ...
            <p className="home-page-para">
              Experience seamless laundry care in four simple steps: <br />{" "}
              order online, enjoy convenient pick-up, trust our expert <br />
              cleaning, and receive hassle-free delivery to your doorstep.
            </p>
          </div>
        ...
        <div className="service-types">
          <div className="reg-service">
            ...
            <p className="home-page-para">
              Reliable, scheduled laundry solutions for everyday convenience.
            </p>
          </div>
          <div className="urg-service">
            <h2 className="category-heading">Urgent</h2>
            <p className="home-page-para">
              Instant laundry care for when time is of the essence.
            </p>
          </div>
        </div>
        ...
        <div className="gradient-section-bottom">
            ...
            <div className="testimonial-set">
              <div className="testimonial-set-photo">
                <a className="home-page-a" href="#">
                  <img
                    src="./src/assets/Testimonial-photo.png"
              ...
              <div className="testimonial-text-section">
                <h2 className="testimonial-heading">
                  Check What our Customers <br /> Say About Us
                </h2>
                <div className="slide-container">
                  <div className="sliding-div current">
                    ...
                    <p>
                      &#34;Laundry Lift made laundry day a breeze! Easy online
                      ordering, quick pick-up, and expert cleaning. Highly
                      recommended!&#34;
                    </p>
                  </div>
                  ...
                  <div className="sliding-div">
                    ...
                    <p>
                      &#34;Seamless service from Laundry Lift! Convenient online
                      orders, swift pick-ups, and top-notch cleaning. Try it—you
                  ...
                  <div className="sliding-div">
                    ...
                    <p>
                      &#34;Life&#39;s easier with Laundry Lift. Quick online
                      orders, efficient pick-ups, and quality cleaning. A happy,
                      satisfied customer!&#34;
                    </p>
                  </div>
                </div>
          ...
          <div className="form-container">
            ...
            <p className="Newsletter-para">
              Get 10% off your first order when you <br /> sign up for our email
              list.
            </p>
            <form>
              <input
